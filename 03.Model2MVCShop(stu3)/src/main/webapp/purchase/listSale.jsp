...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<tr>
	  ...
	  <c:set var="i" value="0" />
	<c:forEach var="purchase" items="${list2}">
		...
		<c:if test="${purhase.tranCode.equals('3')}">
		배송완료
		</c:if>
		...
		<td align ="left">	
		<c:if test="${purchase.tranCode.equals('2')}">
		<a href="/updateTranCodeByProd.do?tranNo=${purchase.tranNo}&tranCode=${purchase.tranCode}">물건도착</a>
		</c:if>
		</td>	
	</tr>
	<tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
	<tr>
		...
		<input type="hidden" id="currentPage" name="currentPage" value=""/>
			...
			<jsp:include page="../common/pageNavigator4.jsp"/>	
		</td>
	</tr>
</table>
